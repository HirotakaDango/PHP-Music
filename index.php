  ...
  switch ($action) {
    ...
    case 'get_favorites':
      ...
      $sort_map = [
        ...
        'year_desc' => 'ORDER BY m.year DESC, m.album COLLATE NOCASE ASC, m.title COLLATE NOCASE ASC',
        'year_asc' => 'ORDER BY m.year ASC, m.album COLLATE NOCASE ASC, m.title COLLATE NOCASE ASC',
        'modified_desc' => 'ORDER BY m.last_modified DESC',
        'modified_asc' => 'ORDER BY m.last_modified ASC',
      ];
    ...
    case 'get_playlist_songs':
      ...
      $sort_map = [
        ...
        'year_desc' => 'ORDER BY m.year DESC, m.album COLLATE NOCASE ASC, m.title COLLATE NOCASE ASC',
        'year_asc' => 'ORDER BY m.year ASC, m.album COLLATE NOCASE ASC, m.title COLLATE NOCASE ASC',
        'added_at_desc' => 'ORDER BY ps.added_at DESC',
        'added_at_asc' => 'ORDER BY ps.added_at ASC',
        'modified_desc' => 'ORDER BY m.last_modified DESC',
      ];
      $order_by = $sort_map[$sort_key] ?? $sort_map['manual_order'];
        ...
        const setupSortOptions = (viewType) => {
          ...
          if (isSortable) {
            ...
            if (viewType === 'get_favorites' || viewType === 'playlist_songs') {
              ...
              if (viewType === 'playlist_songs') {
                options['added_at_desc'] = 'Date Added (Newest)';
                options['added_at_asc'] = 'Date Added (Oldest)';
              }
              options['modified_desc'] = 'Date Modified (Newest)';
              options['modified_asc'] = 'Date Modified (Oldest)';
            }
